          ...
          popupList: [
            {
              type: 'StaticText',
              name: '文本描述',
              value: '<p>这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~这是一段弹窗文本哦~~~</p>',
              link: '',
              popupList: [],
              backgroundImage: '',
              backgroundColor: '',
