import { defineComponent, defineAsyncComponent, resolveComponent, computed } from "vue"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    // const Widget = resolveComponent('Wg' + props.item.type)
    ...
    return () => (
      <div class={wgViewClass.value} style={wgViewStyle.value}>
        {props.item.type === 'StaticText' ? <WgStaticText item={props.item} /> : 123}
