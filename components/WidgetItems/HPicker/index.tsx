...
export default defineComponent({
  ...
  setup(props) {
    // HScrollPicker 组件按需加载
    const HScrollPicker = defineAsyncComponent(() => import('./HScrollPicker'))
    ...
    return () => (
      <div id={props.item.key} class={wrapClass} style={props.item.style}>
        <div class="wg-title flex-none" style={{ width: changeRem(props.item.label.labelWidth) }}>
